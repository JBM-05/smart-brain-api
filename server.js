...
const postgres = knex({
  client: "pg",
  connection: {
    host: "postgresql://smart_brain_db_syv4_user:pjCqEdSF9P2PhDD5qjrB6hvQYhFjkHUF@dpg-cs3vd2bv2p9s73em51h0-a.oregon-postgres.render.com/smart_brain_db_syv4",  // Render database host
